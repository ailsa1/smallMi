    ...
    $.ajax({
        ...
        success: function (json) {
           ...
           for(var i=0;i<json.length;i++){
                results += '<li code="'+json[i].code+'"><div class="mitu"><img src="' + json[i].imgurl + '" alt=""></div><div class="describe"><a href="#"><h3>' + json[i].type + '</h3></a><p>' + json[i].title + '</p><sup>' + json[i].price + '</sup><span>' + json[i].Yprice + '</span><a href="#"><div class="btn"><p>立即购买</p></div></a></div></li>'
           }
            //     // if (json[i] != null) {
